...
class Employee:
    def __init__(self, home_ui):
        ...
        self.home_ui.bio2_next.clicked.connect(self.goto_home_again)
    ...
    def goto_home_again(self):
        home_2_page = self.home_ui.main_page.indexOf(self.home_ui.home_page)
        self.home_ui.main_page.setCurrentIndex(home_2_page)
...
class HumanResource:
    def __init__(self):
        ...
        self.hr_ui.admin_logout_btn.clicked.connect(self.goto_home)

        self.hr_ui.hr_employee_view.clicked.connect(self.goto_hr_view_employee)

    def goto_home(self):
        global_home_ui.showMaximized()
        self.admin_ui.close()

    def goto_hr_view_employee(self):
        employee_view_page = self.hr_ui.admin_employee_sc_pages.indexOf(self.admin_ui.employee_view_page)
        self.admin_ui.admin_employee_sc_pages.setCurrentIndex(employee_view_page)
